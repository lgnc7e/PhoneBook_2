...
public class LoginTests extends TestBase {
    ...
    public void loginExistedUserPositiveTest1() {
        ...
        //fillInRegistrationForm(new User("muster321@gmail.com", "Password1@"));
        app.getUserHelper().fillInRegistrationForm(new User()
                .setEmail("muster6543210@gmail.com")
    ...
    public void loginExistedUserPositiveTest2(ITestContext context) {
        //logger.info("Test ******@BeforeMethod");

        String email = "muster321@gmail.com";
        String password = "Password@321";
        context.setAttribute("email", email);
        context.setAttribute("email", password);
    ...
    public void loginNegativeWOEmailTest() {
        app.getUserHelper().clickLoginLink();
        app.getUserHelper().fillInRegistrationForm(new User()
                //  .setEmail("muster321@gmail.com")
                .setPassword("Password@321"));
        app.getUserHelper().clickOnLoginButton();
        Assert.assertEquals(app.getUserHelper().alertTextPresent(), "Wrong email or password2", "Message are not equals");
        Assert.assertTrue(app.getUserHelper().isAlertPresent());
    }

//    @AfterMethod
//    public void postCondition(){
//        logger.info("Hello ******@AfterMethod");
//    }
